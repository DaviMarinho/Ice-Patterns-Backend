...
export class Default1699405509698 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "sublevel" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "numSublevel" integer NOT NULL, "numLevel" integer NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_aff07a66e8c53a3beaee172c44b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("username" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "email" character varying NOT NULL, "name" character varying NOT NULL, "password" character varying NOT NULL, "qtBooster" integer NOT NULL DEFAULT '0', "qtEnergy" integer NOT NULL DEFAULT '0', "qtCube" integer NOT NULL DEFAULT '0', "qtXpOnLevel" integer NOT NULL DEFAULT '0', "qtXpTotal" integer NOT NULL DEFAULT '0', "sublevelId" uuid, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_78a916df40e02a9deb1c4b75edb" PRIMARY KEY ("username"))`);
        ...
        await queryRunner.query(`CREATE TABLE "mission" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "rewardBooster" integer NOT NULL, "rewardEnergy" integer NOT NULL, "rewardCube" integer NOT NULL, "unlocksOnLevel" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_54f1391034bc7dd30666dee0d4c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_mission" ("userUsername" character varying NOT NULL, "missionId" character varying NOT NULL, "progress" integer NOT NULL, "dateTimeStarted" TIMESTAMP WITH TIME ZONE NOT NULL, "dateTimeCompleted" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_0eaba265d7be38f02bcf3189bf6" PRIMARY KEY ("userUsername", "missionId"))`);
