...
export class Default1699405509698 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_mission" ("userUsername" character varying NOT NULL, "missionId" uuid NOT NULL, "progress" integer NOT NULL, "dateTimeStarted" TIMESTAMP WITH TIME ZONE NOT NULL, "dateTimeCompleted" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_0eaba265d7be38f02bcf3189bf6" PRIMARY KEY ("userUsername", "missionId"))`);
