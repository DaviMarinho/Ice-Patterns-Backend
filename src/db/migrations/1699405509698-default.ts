...
export class Default1699405509698 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "alternative" ("num" character varying NOT NULL, "exerciseId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "text" character varying NOT NULL, "isAnswer" boolean NOT NULL, CONSTRAINT "PK_eef33303e210fefb3d30edf043a" PRIMARY KEY ("num", "exerciseId"))`);
